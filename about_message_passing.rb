...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # THINK ABOUT IT:
    #
    # Q: Why does Ruby provide both send and __send__ ?
    #
    # A: To keep the original method on hand, in the form of __send__, in case send is overloaded.
  ...
  class MessageCatcher
    def add_a_payload(*args)   # Note to C programmers: This isn't a pointer. It's multiple parameters.
      args
    end
  end
  ...
  def test_sending_a_message_with_arguments
    ...
    assert_equal [3, 4, nil, 6], mc.send(:add_a_payload, 3, 4, nil, 6)   # You just called the class through Smalltalk/ObjC-style message-passing!
  end
  ...
  # Contrast with Objective C, where the message just goes unheard if
